...
public class ViewTagsDisplayContext {
	...
	public ViewTagsDisplayContext(GroupLocalService groupLocalService,
				...
				unsafeConsumer -> {
					unsafeConsumer.accept(
						JSONUtil.put(
							...
							"label", "Export/Import Vocabularies"
						));
					unsafeConsumer.accept(
						JSONUtil.put(
							"href",
	...
	private String _getControlPanelPortletURL(String portletId)
		...
		return PortletURLBuilder.create(
			PortalUtil.getControlPanelPortletURL(
				_httpServletRequest,
				_groupLocalService.getGroup(_themeDisplay.getScopeGroupId()),
