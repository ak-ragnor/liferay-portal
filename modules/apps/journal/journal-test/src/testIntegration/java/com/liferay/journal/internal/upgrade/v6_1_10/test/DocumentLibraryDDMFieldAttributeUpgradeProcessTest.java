...
public class DocumentLibraryDDMFieldAttributeUpgradeProcessTest {
	...
	public void testUpgradeImageGalleryURLWithMissingFileEntry()
		...
		Assert.assertEquals(
			StringPool.BLANK, _getValueString(ddmFormValues, LocaleUtil.US));
	}
	...
	public void testUpgradeLocalizedImageGalleryURLs() throws Exception {
		...
		Assert.assertEquals(
			StringPool.BLANK, _getValueString(ddmFormValues, LocaleUtil.SPAIN));
	}
	...
	public void testUpgradeUnknownValue() throws Exception {
		...
		DDMFormValues ddmFormValues = _upgrade(value);
	...
	private DDMFormValues _upgrade(String... values) throws Exception {
		...
		ddmForm.addDDMFormField(
			DDMFormTestUtil.createDDMFormField(
				...
				DDMFormFieldTypeConstants.DOCUMENT_LIBRARY, true, false,
				false));
